...
public class NamesDBHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "NamesDB.db";
    private static final int DATABASE_VERSION = 1;

    private static final String TABLE_NAME = "NamesDB";


    public NamesDBHelper(@Nullable Context context) {
    ...
    public boolean SQLExist(@NotNull String what, String letter){
        try{
           ...
           // System.out.println("FUCKED IN NamesDBHelper + " + e);
            return false;
        }
    }
    public String GetRand(int letter_int, int rand){
       // System.out.println("NAMESDBHELPER GETRAND rand + " + rand);
        String seqid = "";
        SQLiteDatabase db = this.getReadableDatabase();
        ...
        if(db != null){
            ...
            if (c.getCount() > 0) {
                ...
                try{
                    ...
                    //System.out.println("WARNING CUSTOM NamesDB FUCKED " + e);
                    c.close();
                    return "";
                }
            }else{
