...
public class SurnamesDBHelper extends SQLiteOpenHelper {

    private static final String DATABASE_NAME = "SurnamesDB.db";
    private static final int DATABASE_VERSION = 1;

    private static final String TABLE_NAME = "SurnamesDB";


    public SurnamesDBHelper(@Nullable Context context) {
    ...
    public boolean SQLExist(@NotNull String what, String letter){
        try{
           ...
           // System.out.println("FUCKED IN SurnamesDBHelper + " + e);
            return false;
        }
    }

    public String GetRand(int letter_int, int rand){
       // System.out.println("Surnames GETRAND rand + " + rand);
        String seqid = "";
        SQLiteDatabase db = this.getReadableDatabase();
        ...
        if(db != null){
            ...
            if (c.getCount() > 0) {
                ...
                try{
                    ...
                    //System.out.println("WARNING CUSTOM SurnamesDB FUCKED " + e);
                    c.close();
                    return "";
                }
            }else{
