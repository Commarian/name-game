...
public class BugActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit = findViewById(R.id.SubmitBugBtn);
        cancel = findViewById(R.id.cancelBugBtn);
        bugInfo = findViewById(R.id.etMoreInfoBug);
        ...
        submit.setOnClickListener(v -> {
            ...
            bugString = bugInfo.getText().toString();
            if(!bugString.equals("")){
                if(!staticUserID.equals("")){
                    rdb.getReference().child(staticUserID).child("Bug").setValue(bugString).addOnSuccessListener(aVoid -> {
                        bugInfo.setText(R.string.thank_you_input);
                ...
                Snackbar snackbar = Snackbar.make(findViewById(android.R.id.content), R.string.please_enter_bug_above, Snackbar.LENGTH_LONG);
    ...
    void Backgrounds(){
        bg_0 = findViewById(R.id.bg_0_bug);
        bg_1 = findViewById(R.id.bg_2_bug);
        bg_2 = findViewById(R.id.bg_3_bug);
        bg_3 = findViewById(R.id.bg_4_bug);
        bg_4 = findViewById(R.id.bg_6_bug);
        bg_5 = findViewById(R.id.bg_7_bug);
        bg_6 = findViewById(R.id.bg_8_bug);
        con = this;
        BackgroundClass.SetBackground(con, findViewById(R.id.bug_mv));
        if(!bgran){
            bgran = true;
